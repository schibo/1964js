...
C1964jsConstants = ->
  ...
  #mem map
  @MEMORY_START_RDRAM = 0x00000000
  @MEMORY_START_RAMREGS0 = 0x03F00000
  @MEMORY_START_RAMREGS4 = 0x03F04000
  @MEMORY_START_RAMREGS8 = 0x03F80000
  @MEMORY_START_SPMEM = 0x04000000
  @MEMORY_START_SPREG_1 = 0x04040000
  @MEMORY_START_SPREG_2 = 0x04080000
  @MEMORY_START_DPC = 0x04100000
  @MEMORY_START_DPS = 0x04200000
  @MEMORY_START_MI = 0x04300000
  @MEMORY_START_VI = 0x04400000
  @MEMORY_START_AI = 0x04500000
  @MEMORY_START_PI = 0x04600000
  @MEMORY_START_RI = 0x04700000
  @MEMORY_START_SI = 0x04800000
  @MEMORY_START_C2A1 = 0x05000000
  @MEMORY_START_C1A1 = 0x06000000
  @MEMORY_START_C2A2 = 0x08000000
  @MEMORY_START_ROM_IMAGE = 0x10000000
  @MEMORY_START_GIO = 0x18000000
  @MEMORY_START_PIF = 0x1FC00000
  @MEMORY_START_PIF_RAM = 0x1FC007C0
  @MEMORY_START_C1A3 = 0x1FD00000
  @MEMORY_START_DUMMY = 0x1FFF0000
  @MEMORY_SIZE_RDRAM = 0x800000 #4MB RDRAM + 4MB Expansion = 8MB
  @MEMORY_SIZE_RAMREGS0 = 0x10000
  @MEMORY_SIZE_RAMREGS4 = 0x10000
  @MEMORY_SIZE_RAMREGS8 = 0x10000
  @MEMORY_SIZE_SPMEM = 0x2000
  @MEMORY_SIZE_SPREG_1 = 0x10000
  @MEMORY_SIZE_SPREG_2 = 0x10000
  @MEMORY_SIZE_DPC = 0x10000
  @MEMORY_SIZE_DPS = 0x10000
  @MEMORY_SIZE_MI = 0x10000
  @MEMORY_SIZE_VI = 0x10000
  @MEMORY_SIZE_AI = 0x10000
  @MEMORY_SIZE_PI = 0x10000
  @MEMORY_SIZE_RI = 0x10000
  @MEMORY_SIZE_SI = 0x10000
  @MEMORY_SIZE_C2A1 = 0x8000
  @MEMORY_SIZE_C1A1 = 0x8000
  @MEMORY_SIZE_C2A2 = 0x20000
  @MEMORY_SIZE_GIO_REG = 0x10000
  @MEMORY_SIZE_C1A3 = 0x8000
  @MEMORY_SIZE_PIF = 0x10000
  @MEMORY_SIZE_DUMMY = 0x10000
