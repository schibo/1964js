...
#    string = "m.sw(" + @helpers.RT(i) + "," + @helpers.RS(i) + "+" + @helpers.soffset_imm(i)
  ...
  instr: (i, isDelay) ->
    @r4300i_Instruction[@helpers.fn(i)].call @, i, isDelay

  REGIMM_instr: (i, isDelay) ->
    @REGIMM_Instruction[@helpers.rt(i)].call @, i, isDelay

  COP0_instr: (i, isDelay) ->
    @COP0_Instruction[@helpers.rs(i)].call @, i, isDelay

  COP1_instr: (i, isDelay) ->
    @COP1_Instruction[@helpers.rs(i)].call @, i, isDelay

  TLB_instr: (i, isDelay) ->
    @TLB_Instruction[@helpers.fn(i)].call @, i, isDelay

  COP1_BC_instr: (i, isDelay) ->
    @COP1_BC_Instruction[@helpers.rt(i)].call @, i, isDelay

  COP1_S_instr: (i, isDelay) ->
    @COP1_S_Instruction[@helpers.fn(i)].call @, i, isDelay

  COP1_D_instr: (i, isDelay) ->
    @COP1_D_Instruction[@helpers.fn(i)].call @, i, isDelay

  COP1_W_instr: (i, isDelay) ->
    @COP1_W_Instruction[@helpers.fn(i)].call @, i, isDelay

  COP1_L_instr: (i, isDelay) ->
    @COP1_L_Instruction[@helpers.fn(i)].call @, i, isDelay
